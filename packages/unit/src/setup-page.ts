import { installSuperpowers } from '@jestify/inject-playwright';
import fs from 'fs';
import path from 'path';
import type { Page, Request } from 'playwright';
import url from 'url';

import { findAndBundleModule } from './load-third-party-module';
...
const ROOT_PAGE =
  LOCAL_URL + filePathToUrlPathname(path.join(WEB_FOLDER, 'root.html'));
